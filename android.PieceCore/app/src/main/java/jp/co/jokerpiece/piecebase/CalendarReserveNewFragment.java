...
public class CalendarReserveNewFragment extends Fragment implements ObservableScrollViewCallbacks
{

    ImageView mHeaderImage, activityHeaderImage;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        context = getActivity();
        rootView = inflater.inflate(R.layout.fragment_calendar_reservation_new, container, false);

        activityHeaderImage = (ImageView) getActivity().findViewById(R.id.reserve_background_mask);
    ...
    private void setViewComponent()
    {
        ...
        btnSummit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    edtxtPhone.setHintTextColor(getResources().getColor(R.color.red));
                    edtxtPhone.setHint("メールアドレスを入力して下さい");
                ...
                else
                {
                    ...
                    {
                        edtxtTime.setHintTextColor(getResources().getColor(R.color.red));
                        edtxtTime.setHint("メールアドレスの形式が不正です");
